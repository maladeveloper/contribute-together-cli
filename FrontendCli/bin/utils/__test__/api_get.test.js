const { getIntervals, getTaxByInterval, getAllUsers, getIncomeSourcesByUser, getLatestIntTax, getPaymentByInterval, getIncByIntWithSources, getIncByIntAveraged} = require('../api_get.js')
...
describe('getLatestIntTax', () => {
  it('should return a tax object', async  () =>{
    await restartServer()
    const taxes = await getLatestIntTax() 
    expectATaxObj(taxes)
  })
})
